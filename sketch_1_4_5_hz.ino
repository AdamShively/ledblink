...
void loop()
{
  if(count%4 == 0 ){  //if 100 milliseconds have passed since last time this conditon used
    onOffB();       //toggle blue LED
  }
  if(count%5 == 0 ){  //if 125 milliseconds have passed since last time this conditon used
    onOffW();       //toggle white LED    
  }
  if(count%20 == 0 ){ //if 500 milliseconds have passed since last time this conditon used
